...
class Eig_Normalize():
    ...
    def eigen(self):                                                                                                                 # Define a function to solve the generalized eigenvalue problem
        K = self.K
        M = self.M
    ...
    def normalize_modes(self, v):                                                                                                       # Function to normalize the mode shapes with respect to mass
        M = self.M
...
class SpecNec2024_Sae_Sai_modal():
    ...
    def plot_SpecNEC_modal(self):
        ...
        return ResulF, SaeF, SaiF, Tl, Sds, Sd1 , Sae, Sai, Tie       